...
public class DiceRoller {
	...
	public void printMatrix() {
		this.openScanner();
		System.out.println("Press one of the follwing numbers to process the matrix\r\n" + 
		...
		while(notAccepted) {
		  ...
		  try{             
		    ...
		    if(command == 1||command == 2||command == 3){
		      ...
		      System.out.println("Only one of three commands will work! 1, 2 or 3. This is not rocket science!");
		    }
		  }catch(Exception e) {
			  e.printStackTrace();
		  }
